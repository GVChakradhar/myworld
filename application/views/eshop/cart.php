...
<body class="js">
									...
									<div class="product-gallery">
										<div class="quickview-slider-active">
											<div class="single-slider">
												<img src="<?php echo base_url('eshop_assets/eshop');?>images/modal1.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="<?php echo base_url('eshop_assets/eshop');?>images/modal2.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="<?php echo base_url('eshop_assets/eshop');?>images/modal3.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="<?php echo base_url('eshop_assets/eshop');?>images/modal4.jpg" alt="#">
											</div>
										</div>
									</div>
								<!-- End Product slider -->
	...
	<!-- Fancybox JS -->
	<script src="<?php echo base_url('eshop_assets/eshop');?>js/facnybox.min.js"></script>
	<!-- Waypoints JS -->
	...
	<!-- Ytplayer JS -->
	<script src="<?php echo base_url('eshop_assets/eshop');?>js/ytplayer.min.js"></script>
	<!-- Flex Slider JS -->
